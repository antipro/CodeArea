 ...
 * @author antipro
 */
public class CodeAreaBehavior extends CodeInputControlBehavior<CodeArea> {
    ...
    public CodeAreaBehavior(final CodeArea c) {
        super(c);
        ...
        InputMap<CodeArea> textAreaInputMap = new InputMap<>(c);
        textAreaInputMap.getMappings().addAll(
                keyMapping(HOME,      e -> lineStart(false)),
                keyMapping(END,       e -> lineEnd(false)),
                keyMapping(UP,        e -> skin.moveCaret(CodeInputControlSkin.TextUnit.LINE, CodeInputControlSkin.Direction.UP,   false)),
                keyMapping(DOWN,      e -> skin.moveCaret(CodeInputControlSkin.TextUnit.LINE, CodeInputControlSkin.Direction.DOWN, false)),
                keyMapping(PAGE_UP,   e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PAGE, CodeInputControlSkin.Direction.UP,   false)),
                keyMapping(PAGE_DOWN, e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PAGE, CodeInputControlSkin.Direction.DOWN, false)),

                keyMapping(new KeyBinding(HOME).shift(), e -> lineStart(true)),
                keyMapping(new KeyBinding(END).shift(),       e -> lineEnd(true)),
                keyMapping(new KeyBinding(UP).shift(),        e -> skin.moveCaret(CodeInputControlSkin.TextUnit.LINE, CodeInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(DOWN).shift(),      e -> skin.moveCaret(CodeInputControlSkin.TextUnit.LINE, CodeInputControlSkin.Direction.DOWN, true)),
        ...
        InputMap<CodeArea> macOsInputMap = new InputMap<>(c);
        ...
        macOsInputMap.getMappings().addAll(
                ...
                keyMapping(new KeyBinding(UP).alt(),           e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.UP,   false)),
                keyMapping(new KeyBinding(DOWN).alt(),         e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.DOWN, false)),
                keyMapping(new KeyBinding(UP).alt().shift(),   e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(DOWN).alt().shift(), e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.DOWN, true))
        );
        addDefaultChildMap(textAreaInputMap, macOsInputMap);

        // windows / linux specific mappings
        InputMap<CodeArea> nonMacOsInputMap = new InputMap<>(c);
        nonMacOsInputMap.setInterceptor(e -> PlatformUtil.isMac());
        nonMacOsInputMap.getMappings().addAll(
                keyMapping(new KeyBinding(UP).ctrl(),           e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.UP,   false)),
                keyMapping(new KeyBinding(DOWN).ctrl(),         e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.DOWN, false)),
                keyMapping(new KeyBinding(UP).ctrl().shift(),   e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.UP,   true)),
                keyMapping(new KeyBinding(DOWN).ctrl().shift(), e -> skin.moveCaret(CodeInputControlSkin.TextUnit.PARAGRAPH, CodeInputControlSkin.Direction.DOWN, true))
        );
...
//                    skin.hideCaret();
    ...
    private void lineStart(boolean select) {
        skin.moveCaret(CodeInputControlSkin.TextUnit.LINE, CodeInputControlSkin.Direction.BEGINNING, select);
    }

    private void lineEnd(boolean select) {
        skin.moveCaret(CodeInputControlSkin.TextUnit.LINE, CodeInputControlSkin.Direction.END, select);
    }
