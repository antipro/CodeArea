...
import com.bitifyware.control.behavior.CodeInputControlBehavior;
 ...
 * @author antipro
 */
public abstract class CodeInputControlSkin<T extends CodeInputControl> extends SkinBase<T> {
     ...
     */
    public CodeInputControlSkin(final T control) {
        super(control);
                ...
                if (FXVK.useFXVK()) {
                    ...
                    if (control.isEditable() && control.isFocused()) {
                        FXVK.attach(control);
                            ...
                            !(scene.getFocusOwner() instanceof CodeInputControl &&
                                    ((CodeInputControl)scene.getFocusOwner()).isEditable())) {
                        FXVK.detach();
                    }
                }
            });
    ...
    private final ObjectProperty<Paint> textFill = new StyleableObjectProperty<Paint>(Color.BLACK) {
        ...
        @Override public Object getBean() {
            return CodeInputControlSkin.this;
        }
        ...
        @Override public CssMetaData<CodeInputControl,Paint> getCssMetaData() {
    ...
    private final BooleanProperty displayCaret = new StyleableBooleanProperty(true) {
        ...
        @Override public CssMetaData<CodeInputControl,Boolean> getCssMetaData() {
    ...
    CodeInputControlBehavior getBehavior() {
        return null;
    }
    ...
    boolean isCaretBlinking() {
        return caretBlinking.caretTimeline.getStatus() == Animation.Status.RUNNING;
    }
    ...
    private static class StyleableProperties {
        private static final CssMetaData<CodeInputControl,Paint> TEXT_FILL =
                new CssMetaData<>("-fx-text-fill",
                        PaintConverter.getInstance(), Color.BLACK) {

                    @Override public boolean isSettable(CodeInputControl n) {
                        final CodeInputControlSkin<?> skin = (CodeInputControlSkin<?>) n.getSkin();
                        return skin.textFill == null || !skin.textFill.isBound();
                    }

                    @Override @SuppressWarnings("unchecked")
                    public StyleableProperty<Paint> getStyleableProperty(CodeInputControl n) {
                        final CodeInputControlSkin<?> skin = (CodeInputControlSkin<?>) n.getSkin();
                        return (StyleableProperty<Paint>)skin.textFill;
                    }
                };

        private static final CssMetaData<CodeInputControl,Paint> PROMPT_TEXT_FILL =
        ...
        private static final CssMetaData<CodeInputControl,Paint> HIGHLIGHT_FILL =
        ...
        private static final CssMetaData<CodeInputControl,Paint> HIGHLIGHT_TEXT_FILL =
        ...
        private static final CssMetaData<CodeInputControl,Boolean> DISPLAY_CARET =
                new CssMetaData<>("-fx-display-caret",
                    ...
                    @Override @SuppressWarnings("unchecked")
                    public StyleableProperty<Boolean> getStyleableProperty(CodeInputControl n) {
                        final CodeInputControlSkin<?> skin = (CodeInputControlSkin<?>) n.getSkin();
