...
public class TextFormatter<V> {
     ...
     * It maintains a "binding" between the {@link TextInputControl#textProperty()} }
     ...
     * @see TextField#commitValue()
     * @see TextField#cancelEdit()
     */
     ...
     * <p>
     * The filter itself is an {@code UnaryOperator} that accepts {@link Change} object.
     * It should return a {@link Change} object that contains the actual (filtered)
